    ...
    (function (angular) {
        ...
        var PropDesc = /** @class */ (function (_super) {
            ...
            function PropDesc(propertyName, propertyType, changeEvent, enumType, isNativeControlProperty, priority) {
                var _this = _super.call(this, propertyName, propertyType, changeEvent, enumType, isNativeControlProperty, priority) || this;
                _this._scopeBindingMode = _this.propertyType === wijmo.meta.PropertyType.EventHandler ? '&' :
                    (_this.bindingMode == wijmo.meta.BindingMode.OneWay &&
                        wijmo.meta.isSimpleType(_this.propertyType) ? '@' : '=');
                return _this;
            }
...
(function (wijmo) {
    ...
    (function (angular) {
        ...
        var WjDirective = /** @class */ (function () {
            ...
            WjDirective.prototype._initScopeEvents = function () {
                for (var i in this._events) {
                    ...
                    this._props.push(new angular.PropDesc(event.eventName, wijmo.meta.PropertyType.EventHandler));
                }
            };
            ...
            WjDirective._elemScopeProp = '_elemCntrl';
        ...
        var WjLink = /** @class */ (function () {
            ...
            WjLink.prototype._setupScopeWithControlProperties = function () {
                ...
                for (var i = 0; i < props.length; i++) {
                    ...
                    if (prop.scopeBindingMode === '=' && prop.isNativeControlProperty && prop.shouldUpdateSource) {
                        ...
                        var isFunction = prop.propertyType == wijmo.meta.PropertyType.Function;
                        var isEventHandler = prop.propertyType == wijmo.meta.PropertyType.EventHandler;
            ...
            WjLink.prototype._addWatchers = function () {
                ...
                for (i = 0; i < props.length; i++) {
                    prop = props[i];
                    name = prop.propertyName;
                    if (prop.propertyType !== wijmo.meta.PropertyType.EventHandler && this._isAttrDefined(name)) {
...
(function (wijmo) {
    ...
    (function (angular) {
        ...
        var WjTooltipLink = /** @class */ (function (_super) {
         ...
         *
         */
        var WjValidationError = /** @class */ (function (_super) {
...
(function (wijmo) {
    ...
    (function (angular) {
        ...
        var WjDropDown = /** @class */ (function (_super) {
        ...
        var WjComboBox = /** @class */ (function (_super) {
            ...
            function WjComboBox($compile) {
                var _this = _super.call(this) || this;
                _this._$compile = $compile;
                _this.template = '<div ng-transclude />';
        ...
        var WjAutoComplete = /** @class */ (function (_super) {
            ...
            function WjAutoComplete($compile) {
                return _super.call(this, $compile) || this;
            }
        ...
        var WjItemTemplateLink = /** @class */ (function (_super) {
        ...
        var WjMenuLink = /** @class */ (function (_super) {
        ...
        var WjMenuItemLink = /** @class */ (function (_super) {
        ...
        /**
         * AngularJS directive for the @see:MultiAutoComplete control.
         *
         ...
         * The <b>wj-multi-auto-complete</b> directive extends @see:WjAutoComplete with the following attributes:
         *
         * <dl class="dl-horizontal">
         ...
         *   <dt>selected-items-changed</dt> <dd><code>&</code> The @see:MultiAutoComplete.selectedItemsChanged event handler.</dd>
         * </dl>
         */
        var WjMultiAutoComplete = /** @class */ (function (_super) {
            __extends(WjMultiAutoComplete, _super);
            function WjMultiAutoComplete($compile) {
                return _super.call(this, $compile) || this;
            }
            Object.defineProperty(WjMultiAutoComplete.prototype, "_controlConstructor", {
        ...
        var WjCollectionViewNavigator = /** @class */ (function (_super) {
            ...
            function WjCollectionViewNavigator() {
                var _this = _super.call(this) || this;
                _this.template = '<div class="wj-control wj-content wj-pager">' +
    ...
    (function (angular) {
        ...
        if (wijmo.chart && wijmo.chart.FlexChart) {
            ...
            if (wijmo.chart.hierarchical) {
                ...
                wijmoChart.directive('wjTreeMap', [function () {
            ...
            if (wijmo.chart.analytics) {
                ...
                wijmoChart.directive('wjFlexChartBoxWhisker', [function () {
                        return new WjFlexChartBoxWhisker();
                    }]);
                wijmoChart.directive('wjFlexChartErrorBar', [function () {
        ...
        var WjFlexChartBase = /** @class */ (function (_super) {
        ...
        var WjFlexChartCore = /** @class */ (function (_super) {
        ...
        var WjFlexChartAxis = /** @class */ (function (_super) {
            ...
            function WjFlexChartAxis() {
                var _this = _super.call(this) || this;
                _this.require = ['?^wjFlexChartSeries', '?^wjFinancialChartSeries', '?^wjFlexChart', '?^wjFinancialChart', '?^wjFlexRadar'];
                _this.template = '<div class="wjFlexChartAxis" />';
                return _this;
            }
        ...
        var WjFlexChartLegend = /** @class */ (function (_super) {
            ...
            function WjFlexChartLegend() {
                var _this = _super.call(this) || this;
                _this.require = ['?^wjFlexChart', '?^wjFlexPie', '?^wjSunburst', '?^wjFinancialChart', '?^wjFlexRadar'];
                _this.template = '<div />';
                return _this;
            }
        ...
        // abstract
        var WjFlexChartDataLabelBase = /** @class */ (function (_super) {
            __extends(WjFlexChartDataLabelBase, _super);
            function WjFlexChartDataLabelBase() {
                var _this = _super.call(this) || this;
                _this.require = ['?^wjFlexChart', '?^wjFlexPie', '?^wjSunburst', '?^wjTreeMap'];
                _this.template = '<div />';
                return _this;
            }
        ...
        var WjFlexChartDataLabel = /** @class */ (function (_super) {
            ...
            function WjFlexChartDataLabel() {
                var _this = _super.call(this) || this;
                _this.require = ['^wjFlexChart', '?^wjTreeMap'];
                return _this;
            }
        ...
        var WjFlexPieDataLabel = /** @class */ (function (_super) {
            ...
            function WjFlexPieDataLabel() {
                var _this = _super.call(this) || this;
                _this.require = ['^wjFlexPie', '?^wjSunburst'];
                return _this;
            }
        ...
        var WjSeriesBase = /** @class */ (function (_super) {
            ...
            function WjSeriesBase() {
                var _this = _super.call(this) || this;
                _this.require = ['?^wjFlexChart', '?^wjFinancialChart', '?^wjFlexRadar'];
                _this.template = '<div class="wjSeriesBase" ng-transclude />';
                _this.transclude = true;
                return _this;
            }
            ...
            WjSeriesBase.prototype._initControl = function (element) {
                return _super.prototype._initControl.call(this, undefined);
            };
        ...
        var WjFlexChartSeries = /** @class */ (function (_super) {
            ...
            function WjFlexChartSeries() {
                var _this = _super.call(this) || this;
                _this.require = '^wjFlexChart';
                _this.template = '<div class="wjFlexChartSeries" ng-transclude />';
                return _this;
        ...
        var WjFlexChartLineMarker = /** @class */ (function (_super) {
            ...
            function WjFlexChartLineMarker() {
                var _this = _super.call(this) || this;
                _this.require = ['?^wjFlexChart', '?^wjFinancialChart'];
                return _this;
            }
        ...
        var WjFlexChartDataPoint = /** @class */ (function (_super) {
            ...
            function WjFlexChartDataPoint() {
                var _this = _super.call(this) || this;
                _this.require = ['?^wjFlexChartAnnotation'];
                return _this;
            }
        ...
        var WjFlexChartAnnotationLayer = /** @class */ (function (_super) {
            ...
            function WjFlexChartAnnotationLayer() {
                var _this = _super.call(this) || this;
                _this.require = ['?^wjFlexChart', '?^wjFinancialChart'];
                _this.template = '<div class="wjFlexChartAnnotationLayer" ng-transclude />';
                _this.transclude = true;
                return _this;
            }
        ...
        var WjFlexChartAnnotation = /** @class */ (function (_super) {
            ...
            function WjFlexChartAnnotation() {
                var _this = _super.call(this) || this;
                _this.require = '^wjFlexChartAnnotationLayer';
                _this.template = '<div class="wjFlexChartAnnotation" ng-transclude />';
                _this.transclude = true;
                return _this;
            }
        ...
        var WjFlexChartAnnotationLink = /** @class */ (function (_super) {
         ...
         * </dl>
         */
        var WjFlexChartChartGestures = /** @class */ (function (_super) {
        ...
        /**
         * AngularJS directive for the @see:TreeMap control.
         *
         * <dl class="dl-horizontal">
         *   <dt>items-source</dt>      <dd><code>=</code> An array or @see:ICollectionView
         *                              object that contains data for the chart.</dd>
         ...
         *                              @see:DataLabel content property.</dd>
         *   <dt>rendering</dt>         <dd><code>&</code> The @see:FlexPie.rendering event handler.</dd>
         *   <dt>rendered</dt>          <dd><code>&</code> The @see:FlexPie.rendered event handler.</dd>
         * </dl>
         *
         * The wj-tree-map directive may contain the following child directives:
         * @see:WjFlexChartLegend and @see:WjFlexChartDataLabel.
         */
        var WjTreeMap = /** @class */ (function (_super) {
            ...
            Object.defineProperty(WjTreeMap.prototype, "_controlConstructor", {
            ...
            WjTreeMap.prototype._initProps = function () {
                _super.prototype._initProps.call(this);
                var self = this; // store this in closure as .apply() call overrides the reference
                var lblContentDesc = angular.MetaFactory.findProp('labelContent', this._props);
                lblContentDesc.customHandler = function (scope, control, value, oldValue, link) {
        ...
        var WjFlexRadarSeries = /** @class */ (function (_super) {
            ...
            function WjFlexRadarSeries() {
                var _this = _super.call(this) || this;
                _this.require = '^wjFlexRadar';
                _this.template = '<div class="wjFlexRadarSeries" ng-transclude />';
                return _this;
                //this.transclude = true;
            }
        ...
        var WjFlexRadarAxis = /** @class */ (function (_super) {
            ...
            function WjFlexRadarAxis() {
                var _this = _super.call(this) || this;
                _this.require = ['?^wjFlexRadarSeries', '?^wjFlexRadar'];
                _this.template = '<div class="wjFlexRadarAxis" />';
                return _this;
            }
        ...
        var WjFinancialChartSeries = /** @class */ (function (_super) {
            ...
            function WjFinancialChartSeries() {
                var _this = _super.call(this) || this;
                _this.require = '^wjFinancialChart';
                _this.template = '<div class="wjFinancialChartSeries" ng-transclude />';
                return _this;
                //this.transclude = true;
            }
        ...
        var WjTrendLineBase = /** @class */ (function (_super) {
            ...
            function WjTrendLineBase() {
                var _this = _super.call(this) || this;
                _this.require = ['?^wjFlexChart', '?^wjFinancialChart'];
                _this.template = '<div class="wjTrendLineBase" ng-transclude />';
                return _this;
                //this.transclude = true;
            }
        ...
        var WjFlexChartTrendLine = /** @class */ (function (_super) {
            ...
            function WjFlexChartTrendLine() {
                ...
                _this.template = '<div class="wjTrendLine" ng-transclude />';
                return _this;
                //this.transclude = true;
            }
        ...
        var WjFlexChartMovingAverage = /** @class */ (function (_super) {
            ...
            function WjFlexChartMovingAverage() {
                var _this = _super.call(this) || this;
                //this.require = ['?^wjFlexChart', '?^wjFinancialChart'];
                _this.template = '<div class="wjMovingAverage" ng-transclude />';
                return _this;
                //this.transclude = true;
            }
        ...
        var WjFlexChartYFunctionSeries = /** @class */ (function (_super) {
            ...
            function WjFlexChartYFunctionSeries() {
                var _this = _super.call(this) || this;
                //this.require = ['?^wjFlexChart', '?^wjFinancialChart'];
                _this.template = '<div class="wjYFunctionSeries" ng-transclude />';
                return _this;
                //this.transclude = true;
            }
        ...
        var WjFlexChartParametricFunctionSeries = /** @class */ (function (_super) {
            ...
            function WjFlexChartParametricFunctionSeries() {
                var _this = _super.call(this) || this;
                //this.require = ['?^wjFlexChart', '?^wjFinancialChart'];
                _this.template = '<div class="wjParametricFunctionSeries" ng-transclude />';
                return _this;
                //this.transclude = true;
            }
        ...
        var WjFlexChartWaterfall = /** @class */ (function (_super) {
            ...
            function WjFlexChartWaterfall() {
                var _this = _super.call(this) || this;
                _this.require = ['?^wjFlexChart', '?^wjFinancialChart'];
                _this.template = '<div class="wjWaterfall" ng-transclude />';
                return _this;
                //this.transclude = true;
            }
        ...
        /**
         * AngularJS directive for the @see:FlexChart and @see:FinancialChart @see:BoxWhisker object.
         *
         * The <b>wj-flex-chart-box-whisker</b> directive must be contained in a @see:WjFlexChart or @see:WjFinancialChart directive.
         * It supports the following attributes:
         *
         * <dl class="dl-horizontal">
         *   <dt>binding</dt>      <dd><code>@</code> The name of the property that contains Y values for the
        ...
        var WjFlexChartBoxWhisker = /** @class */ (function (_super) {
            ...
            function WjFlexChartBoxWhisker() {
                var _this = _super.call(this) || this;
                _this.require = ['?^wjFlexChart', '?^wjFinancialChart'];
                _this.template = '<div class="wjBoxWhisker" ng-transclude />';
                return _this;
                //this.transclude = true;
            }
            Object.defineProperty(WjFlexChartBoxWhisker.prototype, "_controlConstructor", {
                get: function () {
        ...
        /**
         * AngularJS directive for the @see:FlexChart @see:ErrorBar object.
         *
         * The <b>wj-flex-chart-error-bar</b> directive must be contained in a @see:WjFlexChart directive.
         * It supports the following attributes:
         *
         * <dl class="dl-horizontal">
         *   <dt>binding</dt>      <dd><code>@</code> The name of the property that contains Y values for the
        ...
        var WjFlexChartErrorBar = /** @class */ (function (_super) {
            ...
            function WjFlexChartErrorBar() {
                var _this = _super.call(this) || this;
                _this.require = ['?^wjFlexChart'];
                _this.template = '<div class="wjErrorBar" ng-transclude />';
                return _this;
                //this.transclude = true;
            }
            Object.defineProperty(WjFlexChartErrorBar.prototype, "_controlConstructor", {
                get: function () {
        ...
        var WjFlexChartPlotArea = /** @class */ (function (_super) {
            ...
            function WjFlexChartPlotArea() {
                var _this = _super.call(this) || this;
                _this.require = ['?^wjFlexChartPlotArea', '?^wjFlexChart', '?^wjFinancialChart'];
                _this.template = '<div class="wjFlexChartPlotArea" />';
                return _this;
            }
        ...
        var WjFlexChartFibonacci = /** @class */ (function (_super) {
            ...
            function WjFlexChartFibonacci() {
                var _this = _super.call(this) || this;
                _this.require = ['?^wjFinancialChart'];
                _this.template = '<div class="wjFlexChartFibonacci" ng-transclude />';
                return _this;
                //this.transclude = true;
            }
        ...
        var WjFlexChartFibonacciArcs = /** @class */ (function (_super) {
            ...
            function WjFlexChartFibonacciArcs() {
                var _this = _super.call(this) || this;
                _this.require = ['?^wjFinancialChart'];
                _this.template = '<div class="wjFlexChartFibonacciArcs" ng-transclude />';
                return _this;
            }
        ...
        var WjFlexChartFibonacciFans = /** @class */ (function (_super) {
            ...
            function WjFlexChartFibonacciFans() {
                var _this = _super.call(this) || this;
                _this.require = ['?^wjFinancialChart'];
                _this.template = '<div class="wjFlexChartFibonacciFans" ng-transclude />';
                return _this;
            }
        ...
        var WjFlexChartFibonacciTimeZones = /** @class */ (function (_super) {
            ...
            function WjFlexChartFibonacciTimeZones() {
                var _this = _super.call(this) || this;
                _this.require = ['?^wjFinancialChart'];
                _this.template = '<div class="wjFlexChartFibonacciTimeZones" ng-transclude />';
                return _this;
            }
        ...
        var WjBaseOverlayIndicator = /** @class */ (function (_super) {
            ...
            function WjBaseOverlayIndicator() {
                var _this = _super.call(this) || this;
                _this.require = '^wjFinancialChart';
                _this.template = '<div class="wjBaseOverlayIndicator" ng-transclude />';
                return _this;
            }
        ...
        var WjBaseSingleOverlayIndicator = /** @class */ (function (_super) {
            ...
            function WjBaseSingleOverlayIndicator() {
                var _this = _super.call(this) || this;
                _this.template = '<div class="wjBaseSingleOverlayIndicator" ng-transclude />';
                return _this;
            }
        ...
        var WjFlexChartAtr = /** @class */ (function (_super) {
            ...
            function WjFlexChartAtr() {
                var _this = _super.call(this) || this;
                _this.template = '<div class="wjFlexChartAtr" ng-transclude />';
                return _this;
            }
        ...
        var WjFlexChartCci = /** @class */ (function (_super) {
            ...
            function WjFlexChartCci() {
                var _this = _super.call(this) || this;
                _this.template = '<div class="wjFlexChartCci" ng-transclude />';
                return _this;
            }
        ...
        var WjFlexChartRsi = /** @class */ (function (_super) {
            ...
            function WjFlexChartRsi() {
                var _this = _super.call(this) || this;
                _this.template = '<div class="wjFlexChartRsi" ng-transclude />';
                return _this;
            }
        ...
        var WjFlexChartWilliamsR = /** @class */ (function (_super) {
            ...
            function WjFlexChartWilliamsR() {
                var _this = _super.call(this) || this;
                _this.template = '<div class="wjFlexChartWilliamsR" ng-transclude />';
                return _this;
            }
        ...
        var WjFlexChartMacdBase = /** @class */ (function (_super) {
            ...
            function WjFlexChartMacdBase() {
                var _this = _super.call(this) || this;
                _this.template = '<div class="wjFlexChartBaseMacd" ng-transclude />';
                return _this;
            }
        ...
        var WjFlexChartMacd = /** @class */ (function (_super) {
            ...
            function WjFlexChartMacd() {
                var _this = _super.call(this) || this;
                _this.template = '<div class="wjFlexChartMacd" ng-transclude />';
                return _this;
            }
        ...
        var WjFlexChartMacdHistogram = /** @class */ (function (_super) {
            ...
            function WjFlexChartMacdHistogram() {
                var _this = _super.call(this) || this;
                _this.template = '<div class="wjFlexChartMacdHistogram" ng-transclude />';
                return _this;
            }
        ...
        var WjFlexChartStochastic = /** @class */ (function (_super) {
            ...
            function WjFlexChartStochastic() {
                var _this = _super.call(this) || this;
                _this.template = '<div class="wjFlexChartStochastic" ng-transclude />';
                return _this;
            }
        ...
        var WjFlexChartBollingerBands = /** @class */ (function (_super) {
            ...
            function WjFlexChartBollingerBands() {
                var _this = _super.call(this) || this;
                _this.template = '<div class="wjFlexChartBollingerBands" ng-transclude />';
                return _this;
            }
        ...
        var WjFlexChartEnvelopes = /** @class */ (function (_super) {
            ...
            function WjFlexChartEnvelopes() {
                var _this = _super.call(this) || this;
                _this.template = '<div class="wjFlexChartEnvelopes" ng-transclude />';
                return _this;
            }
...
(function (wijmo) {
    ...
    (function (angular) {
        ...
        // Abstract class, not for use in markup
        var WjGauge = /** @class */ (function (_super) {
        ...
        var WjRange = /** @class */ (function (_super) {
            ...
            function WjRange() {
                var _this = _super.call(this) || this;
                _this.require = ['?^wjLinearGauge', '?^wjRadialGauge', '?^wjBulletGraph'];
                _this.template = '<div ng-transclude />';
                _this.transclude = true;
                // set up as a child directive
                _this._property = 'ranges';
                _this._isPropertyArray = true;
                return _this;
            }
    ...
    (function (angular) {
        ...
        var WjFlexGrid = /** @class */ (function (_super) {
            ...
            function WjFlexGrid($compile, $interpolate) {
                var _this = _super.call(this) || this;
                _this._$compile = $compile;
                _this._$interpolate = $interpolate;
                var self = _this;
                //super();
                _this.transclude = true;
                _this.template = '<div ng-transclude />';
        ...
        var WjFlexGridLink = /** @class */ (function (_super) {
        ...
        var DirectiveCellFactory = /** @class */ (function (_super) {
            ...
            function DirectiveCellFactory(grid, gridLink) {
                ...
                _this._grid = grid;
                _this._gridLink = gridLink;
                _this._rowHeightUpdates = new _RowHeightUpdateQueue(_this);
                // init _templateTypes
                ...
                _this._evtChange = document.createEvent('HTMLEvents');
                _this._evtChange.initEvent('change', true, false);
                ...
                grid.beginningEdit.addHandler(function (s, e) {
                    ...
                    if (e.data && (!(e.data instanceof KeyboardEvent) || e.data.charCode <= 32)) {
                        self._editChar = null;
                    }
                            ...
                            if (isTpl) {
                                ...
                                setTimeout(function () {
                                    ...
                                    if (self._updateRowHeight(panel, cell, rng, cellStamp)) {
                                        ...
                                        self._setFullEdit(templContext);
                                                        ...
                                                        setTimeout(function () {
                                                            if (self._editChar) {
                                                                ...
                                                                if (DirectiveCellFactory.isNgIE &&
                                                                    ...
                                                                    input.dispatchEvent(self._evtChange);
                                                                }
                                                                else {
            ...
            DirectiveCellFactory.isNgIE = !!document['documentMode'];
            return DirectiveCellFactory;
        }(wijmo.grid.CellFactory));
        var _RowHeightUpdateQueue = /** @class */ (function () {
        ...
        var WjFlexGridColumn = /** @class */ (function (_super) {
            ...
            function WjFlexGridColumn($compile) {
                ...
                _this.scope["dataMap"] += "map";
                _this.scope["dataType"] += "type";
                _this.require = '^wjFlexGrid';
                _this['terminal'] = true;
                ...
                if (angular.WjDirective._dynaTemplates) {
                    ...
                    _this.transclude = true;
                    _this.template = '<div class="wjGridColumn" ng-transclude/>';
                }
                return _this;
            }
        ...
        var WjFlexGridColumnLink = /** @class */ (function (_super) {
        ...
        })(CellTemplateType = angular.CellTemplateType || (angular.CellTemplateType = {}));
        /**
        ...
        * &lt;/wj-flex-grid&gt;</pre>
         */
        var WjFlexGridCellTemplate = /** @class */ (function (_super) {
            __extends(WjFlexGridCellTemplate, _super);
            function WjFlexGridCellTemplate() {
                var _this = _super.call(this) || this;
                _this.require = ['?^wjFlexGridColumn', '?^wjFlexGrid'];
                // The same approach like in WjFlexGridColumn
                _this['terminal'] = true;
                if (angular.WjDirective._dynaTemplates) {
                    _this.transclude = false;
        ...
        var WjFlexGridCellTemplateLink = /** @class */ (function (_super) {
            ...
            WjFlexGridCellTemplateLink.prototype._initParent = function () {
                ...
                if (control.cellTemplate || control.cellStyle || control.cellClass) {
                    ...
                    var parentCtrl = this.parent.control;
        ...
        var WjFlexGridDetailLink = /** @class */ (function (_super) {
            ...
            WjFlexGridDetailLink.prototype._initParent = function () {
                ...
                dp.createDetailCell = function (row, col) {
                    ...
                    clonedElement[angular.WjDirective._elemScopeProp] = cellScope;
                ...
                dp.disposeDetailCell = function (row) {
                    if (row.detail) {
                        ...
                        var scope = row.detail[angular.WjDirective._elemScopeProp];
                        if (scope) {
                            scope.$destroy();
                        }
                    }
        ...
        var WjFlexSheet = /** @class */ (function (_super) {
            ...
            function WjFlexSheet($compile, $interpolate) {
                return _super.call(this, $compile, $interpolate) || this;
            }
        ...
        var WjSheetLink = /** @class */ (function (_super) {
...
(function (wijmo) {
    var angular;
    (function (angular) {
        //#region "Viewer directives registration"
        var wijmoViewer = window['angular'].module('wj.viewer', []);
        // register only if module is loaded
        if (wijmo.viewer && wijmo.viewer.ReportViewer) {
        ...
        // Abstract class, not for use in markup
        var WjViewerBase = /** @class */ (function (_super) {
            __extends(WjViewerBase, _super);
            // Creates a new instance of a WjViewerBase
            function WjViewerBase() {
                var _this = _super.call(this) || this;
                _this.template = '<div ng-transclude />';
                _this.transclude = true;
                return _this;
            }
            Object.defineProperty(WjViewerBase.prototype, "_controlConstructor", {
                get: function () {
        ...
        /**
         * AngularJS directive for the @see:ReportViewer control.
         *
         ...
         *   <dt>control</dt>       <dd><code>=</code> A reference to the @see:ReportViewer
         *                          control created by this directive. </dd>
         ...
         *   <dt>page-index-changed</dt>     <dd><code>&</code> The @see:ReportViewer.pageIndexChanged event handler.</dd>
         *   <dt>view-mode-changed</dt>    <dd><code>&</code> The @see:ReportViewer.viewModeChanged event handler.</dd>
         *   <dt>mouse-mode-changed</dt>    <dd><code>&</code> The @see:ReportViewer.mouseModeChanged event handler.</dd>
         *   <dt>full-screen-changed</dt>    <dd><code>&</code> The @see:ReportViewer.fullScreenChanged event handler.</dd>
         *   <dt>zoom-factor-changed</dt>    <dd><code>&</code> The @see:ReportViewer.zoomFactorChanged event handler.</dd>
         *   <dt>query-loading-data</dt>    <dd><code>&</code> The @see:ReportViewer.queryLoadingData event handler.</dd>
         * </dl>
         */
        var WjReportViewer = /** @class */ (function (_super) {
            __extends(WjReportViewer, _super);
            // Initializes a new instance of a WjReportViewer
            function WjReportViewer() {
                return _super.call(this) || this;
            }
            Object.defineProperty(WjReportViewer.prototype, "_controlConstructor", {
        ...
        /**
         * AngularJS directive for the @see:PdfViewer control.
         *
         ...
         *   <dt>service-url</dt>  <dd><code>@</code>A value indicating the address of C1 Web API service. </dd>
         *   <dt>file-path</dt>  <dd><code>@</code> A value indicating full path to the document on the server.</dd>
         *   <dt>control</dt>       <dd><code>=</code> A reference to the @see:PdfViewer
         *                          control created by this directive. </dd>
         *   <dt>full-screen</dt>   <dd><code>@</code> A value indicating whether viewer is under full screen mode. </dd>
         *   <dt>zoom-factor</dt>   <dd><code>@</code> A value indicating the current zoom factor to
         *                           show the document pages </dd>
         ...
         *                           initializing the control with attribute values. </dd>
         *   <dt>view-mode</dt>   <dd><code>@</code> A value indicating how to show the document pages. </dd>
         *   <dt>page-index-changed</dt>     <dd><code>&</code> The @see:PdfViewer.pageIndexChanged event handler.</dd>
         *   <dt>view-mode-changed</dt>    <dd><code>&</code> The @see:PdfViewer.viewModeChanged event handler.</dd>
         *   <dt>mouse-mode-changed</dt>    <dd><code>&</code> The @see:PdfViewer.mouseModeChanged event handler.</dd>
         *   <dt>full-screen-changed</dt>    <dd><code>&</code> The @see:PdfViewer.fullScreenChanged event handler.</dd>
         *   <dt>zoom-factor-changed</dt>    <dd><code>&</code> The @see:PdfViewer.zoomFactorChanged event handler.</dd>
         *   <dt>query-loading-data</dt>    <dd><code>&</code> The @see:PdfViewer.queryLoadingData event handler.</dd>
         * </dl>
         */
        var WjPdfViewer = /** @class */ (function (_super) {
            __extends(WjPdfViewer, _super);
            // Initializes a new instance of a WjPdfViewer
            function WjPdfViewer() {
                return _super.call(this) || this;
            }
            Object.defineProperty(WjPdfViewer.prototype, "_controlConstructor", {
...
(function (wijmo) {
    ...
    (function (angular) {
        ...
        var wijmoViewer = window['angular'].module('wj.nav', []);
        // register only if module is loaded
        if (wijmo.nav && wijmo.nav.TreeView) {
            wijmoViewer.directive('wjTreeView', [function () {
        ...
        /**
         * AngularJS directive for the @see:TreeView control.
         *
         ...
         *
         * <dl class="dl-horizontal">
         *   <dt>items-source</dt>          <dd><code>=</code>An array that contains the @see:TreeView items. </dd>
         ...
         *   <dt>control</dt>               <dd><code>=</code> A reference to the @see:TreeView
         *                                  control created by this directive. </dd>
         ...
         *   <dt>is-initialized</dt>        <dd><code>=</code> A value indicating whether the binding has finished
         *                                  initializing the control with attribute values. </dd>
         *   <dt>show-checkboxes</dt>       <dd><code>@</code> A value determines whether the @see:TreeView should
         ...
         *                                  selected.</dd>
         *   <dt>selected-node</dt>         <dd><code>@</code> A value indicating @see:TreeNode that is currently
         *                                  selected.</dd>
         ...
         *   <dt>items-source-changed</dt>  <dd><code>&</code> The @see:TreeView.itemsSourceChanged event handler.</dd>
         *   <dt>loading-items</dt>         <dd><code>&</code> The @see:TreeView.loadingItems event handler.</dd>
         *   <dt>loaded-items</dt>          <dd><code>&</code> The @see:TreeView.loadedItems event handler.</dd>
         *   <dt>item-clicked</dt>          <dd><code>&</code> The @see:TreeView.itemClicked event handler.</dd>
         *   <dt>selected-item-changed</dt> <dd><code>&</code> The @see:TreeView.selectedItemChanged event handler.</dd>
         *   <dt>checked-items-Changed</dt> <dd><code>&</code> The @see:TreeView.checkedItemsChanged event handler.</dd>
         *   <dt>is-collapsed-changing</dt> <dd><code>&</code> The @see:TreeView.isCollapsedChanging event handler.</dd>
         *   <dt>is-collapsed-changed</dt>  <dd><code>&</code> The @see:TreeView.isCollapsedChanged event handler.</dd>
         *   <dt>is-checked-changing</dt>   <dd><code>&</code> The @see:TreeView.isCheckedChanging event handler.</dd>
         *   <dt>is-checked-changed</dt>    <dd><code>&</code> The @see:TreeView.isCheckedChanged event handler.</dd>
         *   <dt>format-item</dt>           <dd><code>&</code> The @see:TreeView.formatItem event handler.</dd>
         *   <dt>drag-start</dt>            <dd><code>&</code> The @see:TreeView.dragStart event handler.</dd>
         *   <dt>drag-over</dt>             <dd><code>&</code> The @see:TreeView.dragOver event handler.</dd>
         *   <dt>drop</dt>                  <dd><code>&</code> The @see:TreeView.drop event handler.</dd>
         *   <dt>drag-end</dt>              <dd><code>&</code> The @see:TreeView.dragEnd event handler.</dd>
         *   <dt>node-edit-starting</dt>    <dd><code>&</code> The @see:TreeView.nodeEditStarting event handler.</dd>
         *   <dt>node-edit-started</dt>     <dd><code>&</code> The @see:TreeView.nodeEditStarted event handler.</dd>
         *   <dt>node-edit-ending</dt>      <dd><code>&</code> The @see:TreeView.nodeEditEnding event handler.</dd>
         *   <dt>node-edit-ended</dt>       <dd><code>&</code> The @see:TreeView.nodeEditEnded event handler.</dd>
         * </dl>
         */
        var WjTreeView = /** @class */ (function (_super) {
            ...
            Object.defineProperty(WjTreeView.prototype, "_controlConstructor", {
                get: function () {
