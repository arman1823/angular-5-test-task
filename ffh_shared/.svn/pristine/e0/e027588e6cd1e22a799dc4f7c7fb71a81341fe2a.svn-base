...
export class WjPivotGrid extends wijmo.olap.PivotGrid implements OnInit, OnDestroy, AfterViewInit {
...
export class WjPivotChart extends wijmo.olap.PivotChart implements OnInit, OnDestroy, AfterViewInit {
    static readonly meta: IWjComponentMetadata = {
        outputs: wjPivotChartMeta.outputs,
    };
    private _wjBehaviour: WjDirectiveBehavior;
...
export class WjPivotPanel extends wijmo.olap.PivotPanel implements OnInit, OnDestroy, AfterViewInit {
    static readonly meta: IWjComponentMetadata = {
        outputs: wjPivotPanelMeta.outputs,
    };
    private _wjBehaviour: WjDirectiveBehavior;
