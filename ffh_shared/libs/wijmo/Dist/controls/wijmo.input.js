            ...
            Popup.prototype.show = function (modal, handleResult) {
                ...
                if (!this.isVisible) {
                    ...
                    if (this.onShowing(e)) {
                        ...
                        wijmo.showPopup(host_1, ref, false, this._fadeIn);
    ...
    (function (input) {
        ...
        var InputNumber = /** @class */ (function (_super) {
            ...
            InputNumber.prototype._isNumeric = function (chr, digitsOnly) {
                var isNum = (chr == this._chrDec) || (chr >= '0' && chr <= '9');
                if (!isNum && !digitsOnly) {
                    isNum = '+-()'.indexOf(chr) > -1;
                }
                return isNum;
            ...
            InputNumber.prototype._updateBtn = function () {
                var showBtn = this.showSpinner && !!this.step, enableBtn = showBtn && wijmo.isNumber(this.value);
            ...
            InputNumber.prototype._setText = function (text) {
                ...
                if (this._composing)
                    return;
                // save state
                var isNegative = this._rxNeg.test(text), delKey = this._delKey;
                        ...
                        case '-':
                            if (this.min >= 0) {
                                ...
                                if (this.value && tbx.selectionStart == tbx.selectionEnd) {
                                    ...
                                    var index = this.text.indexOf(this._chrDec);
                                    if (index < 0) {
                                        index = this._getInputRange(true)[1];
                                    }
                                    wijmo.setSelectionRange(tbx, index);
                                }
                            }
                            e.preventDefault();
                            break;
            ...
            InputNumber.prototype._input = function (e) {
                ...
                setTimeout(function () {
                    ...
                    if (_this.containsFocus()) {
                        ...
                        if (text[0] == '-' && newText[0] != '-') {
                            _this._setSelStartDigits(dec < 0 || sel <= dec ? pos - 1 : pos);
                            return;
                        }
