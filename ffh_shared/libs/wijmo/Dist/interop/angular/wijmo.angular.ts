...
module wijmo.angular {
    ...
    export class MetaFactory extends wijmo.meta.ControlMetaFactory {

        // Override to return wijmo.angular.PropDesc
        public static CreateProp(propertyName: string, propertyType: wijmo.meta.PropertyType,
        ...
        public static findProp(propName: string, props: PropDesc[]): PropDesc {
            return <PropDesc>wijmo.meta.ControlMetaFactory.findProp(propName, props);
        }

        // Typecast override.
        public static findEvent(eventName: string, events: EventDesc[]): EventDesc {
            return <EventDesc>wijmo.meta.ControlMetaFactory.findEvent(eventName, events);
        }

        // Typecast override.
        public static findComplexProp(propName: string, props: ComplexPropDesc[]): ComplexPropDesc {
            return <ComplexPropDesc>wijmo.meta.ControlMetaFactory.findComplexProp(propName, props);
        }
    }

    // Describes a scope property: name, type, binding mode. 
    // Also defines enum type and custom watcher function extender
    export class PropDesc extends wijmo.meta.PropDescBase {
        ...
        // Initializes a new instance of a PropDesc
        constructor(propertyName: string, propertyType: wijmo.meta.PropertyType, changeEvent?: string,
            ...
            this._scopeBindingMode = this.propertyType === wijmo.meta.PropertyType.EventHandler ? '&' :
                (this.bindingMode == wijmo.meta.BindingMode.OneWay &&
                    wijmo.meta.isSimpleType(this.propertyType) ? '@' : '=');
        }
    ...
    // Describes a scope event
    export class EventDesc extends wijmo.meta.EventDescBase {
    }

    // Describes property info for nested directives.
    export class ComplexPropDesc extends wijmo.meta.ComplexPropDescBase {
    }
} 
//
    ...
    export class WjDirective implements ng.IDirective {
        ...
        private _initScopeEvents() {
            for (var i in this._events) {
                ...
                this._props.push(new PropDesc(event.eventName, wijmo.meta.PropertyType.EventHandler));
            }
        }
                                                    ...
                                                    setTimeout(function () {
                                                        if (self._editChar) {
                                                            ...
                                                            if (DirectiveCellFactory.isNgIE &&
                                                                !(hasClass(input, 'wj-form-control') ||
