...
export class WjFlexSheet extends wijmo.grid.sheet.FlexSheet implements OnInit, OnDestroy, AfterViewInit {
...
export class WjSheet extends wijmo.grid.sheet.Sheet implements OnInit, OnDestroy, AfterViewInit {
